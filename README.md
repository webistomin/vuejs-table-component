...
Приложение рендерит страницу регистрации, авторизации, профиля и таблицы с данными. Неавторизованный пользователь не имеет доступа к таблице и его редиректит на станицу входа. Данные формы валидируются через vuelidate. Регистрация и авторизация решил сделать через firebase. Данные таблицы подтягиваются через JSON server. Если данных много, то отображается пагинация. Реализована сортировка таблицы по колонкам
